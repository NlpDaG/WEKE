...
def topicG(topicNum, datasets=['KDD', 'WWW']):
    for dataset in datasets:
        twp_MatrixPath = './data_temp/' + dataset + \
            '/LDA' + topicNum + '/model-final.phi'
        document_topic_Map = './data_temp/' + dataset + \
            '/LDA' + topicNum + '/model-final.tassign'
        word_indexPath = './data_temp/' + dataset + '/LDA' + topicNum + '/wordmap.txt'
        filelistPath = './data_temp/' + dataset + '/abstractsNames'
        resultGPath = './result_graph/' + dataset + '/topicG' + topicNum + '.data'
...
if __name__ == '__main__':
    for topic in ['150','250','350','450']:
        topicG(topic, datasets=['KDD', 'WWW'])
